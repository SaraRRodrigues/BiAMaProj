app.controller("MyQuestionsController", ['$scope', "QuestionService", "FavoritesService", "UserQuestionService", "$http", "jQuery", function($scope, QuestionService,FavoritesService,UserQuestionService, $http){
